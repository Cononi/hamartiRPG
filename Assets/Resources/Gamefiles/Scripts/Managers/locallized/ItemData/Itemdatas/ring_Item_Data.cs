...
public class ring_Item_Data
{
    ...
    public ring_Item_Data()
    { }
    // 링, 목걸이
    public ring_Item_Data(info _info, bool _isEquip, ItemClass _itemClase, int _item_Numbers, string _item_Name, int _holy_Power, int _neutrality_Power, int _heresy_Power, int _damage, int _attack_Vampire, float _heart_Recovery_Time, int _heart_Stance, int _item_Count, int _item_Price, string _item_Ex)
    {
        info = _info;
