...
public class helmat_Item_Data
{
    ...
    public helmat_Item_Data()
    {
    }
    // 투구
    public helmat_Item_Data(bool _Effect,info _info, bool _isEquip, ItemClass _itemClase, int _item_Numbers, string _item_Name, int _holy_Power, int _neutrality_Power, int _heresy_Power, int _stance, int _stiffen_Stance, int _item_Count, int _item_Price, string _item_Ex)
    {
        Effect = _Effect;
        info = _info;
