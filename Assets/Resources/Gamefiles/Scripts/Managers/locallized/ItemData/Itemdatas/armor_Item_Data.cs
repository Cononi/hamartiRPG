...
public class armor_Item_Data
{
    ...
    [Header(" - 최대 체력치")]
    public int Player_numOFHeart; // 체력
    // 무기제외한 나머지 장비 공통사항.
    ...
    public armor_Item_Data()
    {

    }
    // 갑옷.
    public armor_Item_Data(bool _Effect,info _info, bool _isEquip, ItemClass _itemClase, int _item_Numbers, string _item_Name, int _holy_Power, int _neutrality_Power, int _heresy_Power, int _Player_numOFHeart, int _stance, int _stiffen_Stance, int _phoenix_Stance, int _item_Count, int _item_Price, string _item_Ex)
    {
        Effect = _Effect;
        info = _info;
        ...
        Player_numOFHeart = _Player_numOFHeart; // 최대체력
